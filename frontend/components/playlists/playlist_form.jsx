...
class PlaylistForm extends React.Component {
    ...
    handleSubmit(e) { //unused for testing purposes!!!
        e.preventDefault();
        this.props.createPlaylist(this.props.playlistInfo)
        .then(() => this.props.history.push("/"));
    }
    handleUpdateSubmit(e) { //need to somehow rerender both sidebar and show once update is commited
        e.preventDefault();
        let id = Number.parseInt(this.props.match.params.playlistObjId)
        this.props.updatePlaylist(this.state, id)
        .then(() => this.props.history.push("/"));
    }
    update(field) {
                ...
                <div id="playlistModal" className="playlistModalyay">
                    <div className="playlistModalContent">
                        ...
                        <div className="secondModalDiv">
                            ...
                            <form onSubmit={this.handleUpdateSubmit} className="playlistForm">
